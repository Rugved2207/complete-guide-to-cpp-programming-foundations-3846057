...
int main(){
    ...
    char racer1[] = "Speedy"; // At the end of this string is a null character \0. 
    char racer2[LENGTH];
    char raceResult[LENGTH * 2];

    strncpy(racer2, "Lightning", sizeof(racer2) - 1);
    racer2[sizeof(racer2) - 1] = '\0'; // It is important to assign the null character at the end of the array of characters (strings) for them to work properly. 
