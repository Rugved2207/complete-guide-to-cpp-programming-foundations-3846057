...
int main(){
    ...
    points.push_back(std::complex<double>(1.0,7.2));
    points.push_back(std::complex<double>(-2.8,0.4));
    points.push_back(std::complex<double>(5.3,9.1));
    ...
    std::cout << "The last imaginary: " << (points.end() - 1)->imag() << std::endl;
